...
export default function ProfilePage() {
    ...
    function handlePasswordSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (newPassword.length < 8) fieldErrors.newPassword = "รหัสผ่านต้องมีอย่างน้อย 8 ตัวอักษร";
        else if (newPassword !== confirmPassword) fieldErrors.confirmPassword = "รหัสผ่านไม่ตรงกัน";
        ...
        submitChangePassword(newPassword)
            ...
            .catch((err) => setPasswordSubmitError(err instanceof Error ? err.message : "เกิดข้อผิดพลาด"))
        ...
        <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-6">
            ...
            <div>
                ...
                <form onSubmit={handlePasswordSubmit} className="bg-white shadow-sm border border-gray-100 rounded-xl p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    {passwordSubmitError && <p className="sm:col-span-2 text-sm text-red-600">{passwordSubmitError}</p>}
