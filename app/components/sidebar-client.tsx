        ...
        <>
            ...
            `}>
                <div className={`flex h-16 items-center justify-between ${theme.sidebar.headerBorder} px-4`}>
                    <Image src="/logo/fasttiw-logo.svg" alt="Fasttiw" width={101} height={28} className="shrink-0 object-contain" />
                    <button
                        onClick={() => setMobileOpen(false)}
            ...
            `}>
                <div className={`flex h-16 items-center ${collapsed ? "justify-center" : "gap-3 px-4"} ${theme.sidebar.headerBorder}`}>
                    {collapsed ? (
                        <Image src="/logo/fasttiw-mark.svg" alt="Fasttiw" width={32} height={32} className="shrink-0 object-contain" />
                    ) : (
                        <Image src="/logo/fasttiw-logo.svg" alt="Fasttiw" width={145} height={40} className="shrink-0 object-contain" />
                    )}
                </div>
