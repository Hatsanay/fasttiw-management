...
## สเปกที่ล็อกไว้
- สัญลักษณ์: วงฝนคำตอบเปิดช่องด้านหลัง 50° แกนในลอยอิสระ มีขีดความเร็วนำหน้า และมีขา tt ห้อยข้างใต้
- ขา tt คือเส้นตัวอักษร t สองตัวจาก Poppins 600 ของจริง เชื่อมคานเหมือนในคำ ไม่ได้วาดเลียนแบบ
...
logo/
  ...
  fasttiw-symbol.svg / .png   เฉพาะสัญลักษณ์ (วง + ขา tt) ใช้เป็นรูปโปรไฟล์
favicon/
  favicon.svg                 พื้นใส วง + ขา tt ตรงกับโลโก้
  favicon.ico                 16/32/48 รวมไฟล์เดียว สำหรับเบราว์เซอร์เก่า
  favicon-16/32/48.png
  favicon-simple.svg / .ico   ทางเลือก: วงอย่างเดียวไม่มีขา อ่านชัดกว่าที่ 16px
...
- ขนาดเล็กสุดของโลโก้แนวนอน: กว้าง 140px · แนวตั้ง: กว้าง 90px
- โลโก้แนวตั้งใช้สัญลักษณ์แบบวงอย่างเดียว ไม่มีขา ตามที่ตกลงไว้
- favicon หลักมีขา tt ที่ 16px ขาจะเบลอรวมกัน ถ้าเจอปัญหาให้สลับไปใช้ favicon-simple
