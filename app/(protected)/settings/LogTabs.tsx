...
// ทุกหน้าในนี้เป็นเรื่องเดียวกัน (ร่องรอยการใช้งานระบบ) จึงรวมไว้ใต้สิทธิ์เดียวแล้วสลับด้วยแท็บแทน
const TABS = [
    { href: "/settings/audit-logs", label: "การแก้ไขข้อมูล" },
    { href: "/settings/error-logs", label: "ข้อผิดพลาดของระบบ" },
    { href: "/settings/logs", label: "การเข้าสู่ระบบ (แอดมิน)" },
    { href: "/settings/customer-logs", label: "การเข้าสู่ระบบ (ลูกค้า)" },
];
